...
import {useDeleteProductImageMutation, useGetProductDetailsQuery, useUploadProductImagesMutation} from "../../redux/api/productsApi.js"
...
const UploadImages = () => {
    ...
    return (
      <>
            <MetaData title="Upload Image -  Shopholic" />
        <AdminLayout>
